...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Watermark.Text = "Smorg's Hub | nil | nil"
            ...
            Gui.Logo.ImageColor3 = Color3.fromRGB(0, 0, 0) --Gui.Logo.ImageColor3 = Color3.fromRGB(134, 142, 255)
...
function UILibrary.new(gameName, userId, rank)
    ...
    --// Customize the GUI
    window.Watermark.Text = ("Smorg's Hub | %s | %s"):format(userId, gameName)
